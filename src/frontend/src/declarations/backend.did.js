...
export const CustomRSVP = IDL.Record({
  'name' : IDL.Text,
  'email' : IDL.Text,
  'inviteCode' : IDL.Text,
  'timestamp' : Time,
...
export const idlService = IDL.Service({
  ...
  'getAllCustomRSVPs' : IDL.Func([], [IDL.Vec(CustomRSVP)], ['query']),
  ...
  'submitRSVPWithEmail' : IDL.Func([IDL.Text, IDL.Text, IDL.Text], [], []),
});
